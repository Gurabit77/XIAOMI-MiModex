...
import {
  useManagePlugins
} from "./chunk-vz05xsp3.js";
import"./chunk-cfm1q1cq.js";
import {
  WelcomeV2
} from "./chunk-4m1w9q14.js";
import {
  onChangeAppState
...
async function setupTokenHandler(root) {
  ...
  const { ConsoleOAuthFlow } = await import("./chunk-eqtvrsdg.js");
        ...
        children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV(ThemedBox_default, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx_dev_runtime.jsxDEV(ConsoleOAuthFlow, {
              ...
              mode: "setup-token",
              startingMessage: "This will guide you through long-lived (1-year) auth token setup for your MiMo account. MiMo subscription required."
            }, undefined, false, undefined, this)
          ]
        }, undefined, true, undefined, this)
      }, undefined, false, undefined, this)
...
var DoctorLazy = import_react.default.lazy(() => import("./chunk-e6hdmk6m.js").then((m) => ({ default: m.Doctor })));
...
async function installHandler(target, options) {
  ...
  const { install } = await import("./chunk-6n7p9kpc.js");
  await new Promise((resolve) => {
    const args = [];
    if (target)
      args.push(target);

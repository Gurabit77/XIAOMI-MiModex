...
async function startSkillSearch() {
  ...
  try {
    const { clearSkillIndexCache } = await import("./chunk-77k8pjpk.js");
...
async function call(onDone, _context, args) {
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV(SkillSearchPanel, {
    onDone
  }, undefined, false, undefined, this);
}
...
\u542F\u7528\u540E\uFF0CMiMo Code \u4F1A\u5728\u6BCF\u8F6E\u5BF9\u8BDD\u4E2D\u81EA\u52A8\u641C\u7D22\u5E76\u52A0\u8F7D\u4E0E\u5F53\u524D\u4EFB\u52A1\u6700\u76F8\u5173\u7684 skill \u6587\u4EF6\uFF0C
...
3. \u5339\u914D\u5230\u7684 skill \u5185\u5BB9\u4F1A\u4F5C\u4E3A\u4E0A\u4E0B\u6587\u6CE8\u5165\uFF0C\u6307\u5BFC MiMo Code \u7684\u884C\u4E3A

...
function BypassPermissionsModeDialog({
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV(Dialog, {
    title: "WARNING: MiMo Code running in Bypass Permissions mode",
    color: "error",
      ...
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV(ThemedBox_default, {
        ...
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV(ThemedText, {
            children: [
              "In Bypass Permissions mode, MiMo Code will not ask for your approval before running potentially dangerous commands.",

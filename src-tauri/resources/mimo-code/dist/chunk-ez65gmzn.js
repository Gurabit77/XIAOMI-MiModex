...
function SnapshotUpdateDialog({
  ...
  const children = [
    import_react.default.createElement(ThemedText, { dimColor: true, key: "timestamp" }, `Snapshot timestamp: ${snapshotTimestamp}`),
      ...
      options: [
        {
          ...
          value: "merge",
          description: "Keep current memory and ask MiMo to merge in the snapshot changes."
        },
        {
...
function buildMergePrompt(agentType, scope) {
